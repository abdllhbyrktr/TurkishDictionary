...
ExtensionCore.AppEvents = {
    ...
    appStartFunc: function() { console.log("Action is started."); },
    appStop: "ACTION_STOP",
    appStopFunc: function() { console.log("Action is stopped."); },
    appShow: "ACTION_SHOW",
    appShowFunc: function() { console.log("Action is shown."); },
    appHide: "ACTION_HIDE",
    appHideFunc: function() { console.log("Action is hidden."); },
    appError: "ERROR",
    appErrorFunc: function(errorMessage) { console.log("error: ", errorMessage); },
    appLocaleChange: "LOCALE_CHANGED",
    appLocaleChangeFunc: function() { console.log("Action local changed."); }
};
...
mxRuntime.onAppEvent = function (obj) {
    ...
    switch (obj.type) {
        ...
        case ExtensionCore.AppEvents.appHide:
            ...
            break;
        case ExtensionCore.AppEvents.appError:
            ExtensionCore.AppEvents.appErrorFunc(obj.errorMessage);
            break;
        case ExtensionCore.AppEvents.appLocaleChange:
